...
export const POST = async (
  ...
  console.log("[orders/actions/edit] Received body:", JSON.stringify(body, null, 2))
  console.log("[orders/actions/edit] orderId:", orderId)
  ...
  try {
    ...
    console.log("[orders/actions/edit] SQL:", updateQuery)
    console.log("[orders/actions/edit] Values:", values)

    const result = await knex.raw(updateQuery, values)
    
    console.log("[orders/actions/edit] Result:", JSON.stringify(result.rows, null, 2))
    ...
    console.error("[orders/actions/edit] Error:", error)
