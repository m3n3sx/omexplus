...
export const POST = async (
  ...
  console.log("[store/order-update] Received body:", JSON.stringify(body, null, 2))
  console.log("[store/order-update] orderId:", orderId)
  ...
  try {
    ...
    console.log("[store/order-update] SQL:", updateQuery)
    console.log("[store/order-update] Values:", values)

    const result = await knex.raw(updateQuery, values)
    
    console.log("[store/order-update] Result:", JSON.stringify(result.rows, null, 2))
