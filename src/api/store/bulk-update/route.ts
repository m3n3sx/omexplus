 ...
 * 
 * Using /store/ path because new webhook folders are not being loaded by Medusa
 */
...
/**
 * POST /store/bulk-update
 * Bulk update products or orders
 */
...
/**
 * GET /store/bulk-update
 * Health check
 */
export async function GET(_req: MedusaRequest, res: MedusaResponse) {
  res.json({ 
    status: "ok", 
    message: "Bulk update endpoint is active",
